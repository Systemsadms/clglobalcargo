							...
							mysql_close ($conexion);
                              ...
                              <tr>
								...
								Sr(a). '.$_POST['nombres'].', es un gusto para nosotros que usted forme parte de nuestra cartera de clientes. Su usuario y su password para acceer a su cuenta son los siguientes:
								 ...
								 Usted puede cambiar su contraseña cuando guste desde su cuenta en www.clglobalcargo.com/micuenta.php				
								 ...
								 Por lo tanto a partir de ahora al realizar cualquier compra usted debera informarle a su proveedor que la direccion de envio de su carga es la siguiente:
									...
									SHIPPING ADDRESS:
									Nombre: clglobalcargo /SU NOMBRE COMPLETO
									...
									De igual forma lo invitamos a visitar nuestra pagina web www.clglobalcargo.com donde con su usuario y su contrasena, usted podra monitorear el estatus de sus paquetes y asi estar informado sobre la ubicacion del mismo.
										...
										$para="clglobalcargoexpress@gmail.com";
										$para2= $_POST['email'];
										...
										if ( isset ($_POST["btn_enviar"]))
										{
											...
											$asunto2 	= "Bienvenido a C&L Global Cargo Express C.A";
											$desde2		= $_POST["nick"];
											$mensaje2 	= $body2;
											$cabeceras2 = "";
											...
											$cabeceras2 = "From: " . "clglobalcargo@gmail.com" . "\r\n";    
