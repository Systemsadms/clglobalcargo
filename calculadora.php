		...
		//echo $tipo . $largo . $ancho . $alto . $peso;
			...
			if ($tipo == "Aereo")
			{
				...
				?>
                      <table width="350" border="0" align="center" bordercolor="#FF0000">
                        <tr>
                          <td align="center">
						  <?php echo "EL costo estimado de su envio Aereo1 es de" . " " . "<b>" . $final*90 . " bs." . "</b>"; ?>
                          </td>
                        </tr>
                        <tr>
                          <td align="center"></td>
					...
					$final  = number_format($costo,2,".",",");
							...
							?>
                              <table width="350" border="0" align="center" bordercolor="#FF0000">
                                <tr>
                                  <td align="center">
								   <?php echo "EL costo estimado de su envio Aereo2 es de" . " " . "<b>" . $final*90 . " bs." . "</b>"; ?>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center">&nbsp;</td>
			...
			else if ($tipo == "Maritimo")
			{
				...
				?>
                  <table width="350" border="0" align="center" bordercolor="#FF0000">
                    <tr>
                      <td align="center"><?php echo "EL costo estimado de su envio Maritimo es de" . " " . $final*80 . "Bs." . "</b>"; ?></td>
                    </tr>
                    <tr>
                      <td align="center">&nbsp;</td>
                    </tr>
