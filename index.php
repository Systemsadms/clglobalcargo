  	...
  	if (isset($_SESSION["login"]))
	{
        ...
        <table width="200" border="0">
          <tr>
            ...
            <br />.
            <?php
			 echo "<font color='#FFFFFF'><strong><em>'Hola"." ".$micuenta."'</em></strong></font>";
			?>
            </td>
          </tr>
          <tr>
...
<div id="facebook">
<div align="center">
<iframe src="http://widget.stagram.com/follow/clglobalcargoexpress" style="height:27px;" frameborder="0" scrolling="no"></iframe>
</div>
...
<iframe src="http://snapwidget.com/sc/?u=Y2xnbG9iYWxjYXJnb2V4cHJlc3N8aW58OTV8M3wzfHx5ZXN8MjB8bm9uZXxvblN0YXJ0fG5vfG5v&ve=140115" title="Instagram Widget" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:200px; height:95px"></iframe>
...
<table width="630" border="0" align="center">
  <tr>
    <td>
    C&L Global Cargo Express C.A es una empresa líder dedicada al Agenciamiento Aduanal, Nacional e Internacional, a la Consolidación de Carga Aérea, Marítima Y Terrestre;  contando con diversas sucursales.</td>
  </tr>
</table>
<table width="630" border="0" align="center">
  <tr>
