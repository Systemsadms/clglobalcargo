                ...
                <div id="contenido">
                  ...
                  <table width="400" border="0" align="center">
                                 ...
                                 <table width="412" border="0" align="center">
                                  <tr>
                                    <td width="151">Buscar Guias Por:</td>
                                    ...
                                    <td width="85"><input name="buscar" type="submit" id="dato" value="Ver Guias"/></td>
                                  </tr>
                                </table>
                                </form></td>
                                  </tr>
		...
		if(isset ($_POST["buscar"]))
			{
				...
				<div class='AJXLightboxGVHQAXA'><a href='img_guias/guia_".$reg[8].".jpg' rel='ajxlightbox' target='_blank'><img src='img_guias/guia_".$reg[8].".jpg' 				height='25px' width='25px'/></a></div>
				</td>";
